class UserOfficialModel {
  ...
  factory UserOfficialModel.fromJson(Map<String, dynamic> json) {
    return UserOfficialModel(
      ...
      officialUserId: json['user_id'], //for modifying users table such as changing password
      officialBarangayId: json['barangay_id'], //for identifying which barangay this official belongs to
