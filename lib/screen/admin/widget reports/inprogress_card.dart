...
import '../../../screen/admin/pdf_download_stub.dart'
    if (dart.library.html) '../../../screen/admin/pdf_download_web.dart';
                      ...
                      ElevatedButton.icon(
                        onPressed: () async {
                          try {
                            ...
                            if (kIsWeb) {
                              // ✅ Web: trigger browser download via helper
                              PdfDownloadHelper.downloadPdf(pdfBytes, "report.pdf");
                            } else {
