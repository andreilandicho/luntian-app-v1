...
final List<Map<String, dynamic>> _reports = [
  {
    ...
    "submission_date": DateTime.now().subtract(const Duration(days: 2)),
    "report_deadline": DateTime.now().add(const Duration(hours: 6)),
    "status": "Pending",
  ...
  },
  {
    ...
    "submission_date": DateTime.now().subtract(const Duration(days: 1)),
    "report_deadline": DateTime.now().add(const Duration(days: 3)),
    "status": "In Progress",
  ...
  },
  {
    ...
    "submission_date": DateTime.now().subtract(const Duration(days: 1)),
    "report_deadline": DateTime.now().add(const Duration(hours: 12)),
    "status": "Resolved",
  ...
  },
  {
    ...
    "submission_date": DateTime.now().subtract(const Duration(days: 7)),
    "report_deadline": DateTime.now().subtract(const Duration(days: 4)),
    "status": "Pending",
  ...
  },
  {
    ...
    "submission_date": DateTime.now().subtract(const Duration(days: 3)),
    "report_deadline": DateTime.now().subtract(const Duration(hours: 12)),
    "status": "In Progress",
  ...
  },
  {
    ...
    "submission_date": DateTime.now().subtract(const Duration(days: 1)),
    "report_deadline": DateTime.now().add(const Duration(days: 4)),
    "status": "Resolved",
  ...
  },
  {
    ...
    "submission_date": DateTime.now().subtract(const Duration(days: 2)),
    "report_deadline": DateTime.now().add(const Duration(hours: 2)),
    "status": "Pending",
  ...
  },
  {
    ...
    "submission_date": DateTime.now().subtract(const Duration(days: 10)),
    "report_deadline": DateTime.now().subtract(const Duration(days: 8)),
    "status": "Resolved",
  ...
  },
  {
    ...
    "submission_date": DateTime.now().subtract(const Duration(days: 3)),
    "report_deadline": DateTime.now().add(const Duration(hours: 18)),
    "status": "Pending",
  ...
  },
  {
    ...
    "submission_date": DateTime.now().subtract(const Duration(days: 5)),
    "report_deadline": DateTime.now().subtract(const Duration(days: 3)),
    "status": "Pending",
  ...
  },
  {
    ...
    "submission_date": DateTime.now().subtract(const Duration(days: 1)),
    "report_deadline": DateTime.now().add(const Duration(minutes: 30)),
    "status": "Pending",
  ...
  },
  {
    ...
    "submission_date": DateTime.now().subtract(const Duration(days: 4)),
    "report_deadline": DateTime.now().subtract(const Duration(days: 1)),
    "status": "In Progress",
  ...
  },
  {
    ...
    "submission_date": DateTime.now().subtract(const Duration(days: 2)),
    "report_deadline": DateTime.now().add(const Duration(days: 7)),
    "status": "Resolved",
  ...
  },
  {
    ...
    "submission_date": DateTime.now().subtract(const Duration(days: 1)),
    "report_deadline": DateTime.now().add(const Duration(hours: 23)),
    "status": "In Progress",
  ...
  },
  {
    ...
    "submission_date": DateTime.now().subtract(const Duration(days: 6)),
    "report_deadline": DateTime.now().subtract(const Duration(days: 4)),
    "status": "Resolved",
  ...
  },
  {
    ...
    "submission_date": DateTime.now().subtract(const Duration(days: 3)),
    "report_deadline": DateTime.now().add(const Duration(hours: 5)),
    "status": "Pending",
...
Color _rowColor(Map<String, dynamic> report) {
  ...
  void _showEscalationDialog(Map<String, dynamic> report) {
    ...
    String initialEmailContent = _generateEmailTemplate(report, isExpired);
    emailController.text = initialEmailContent;

    showDialog(
      context: context,
      builder: (BuildContext context) {
        return AlertDialog(
          title: const Text('Escalation Email'),
          content: SizedBox(
            ...
            child: Column(
              ...
              children: [
                const Text('To: mhd@manila.gov.ph'),
                const SizedBox(height: 8),
                const Text('Subject: Report Escalation - Urgent Attention Required'),
          ...
          actions: [
            ...
            ElevatedButton(
              onPressed: () async {
                final String emailContent = emailController.text;
                final String encodedContent = Uri.encodeComponent(emailContent);
                final String mailtoLink = 'mailto:mhd@manila.gov.ph?subject=Report%20Escalation%20-%20Urgent%20Attention%20Required&body=$encodedContent';
  ...
  String _generateEmailTemplate(Map<String, dynamic> report, bool isExpired) {
    ...
    return "Dear Manila Health Department,\n\n"
        ...
        "Assigned Official: ${report["assigned_official"]}\n\n"
                                ...
                                cells: [
                                  ...
                                  children: [
                                    if (timeRemaining.inHours <= 24 && 
                                        !timeRemaining.isNegative && 
                                        report["status"] != "Resolved") // Only show icon for non-resolved
                                      const Tooltip(
