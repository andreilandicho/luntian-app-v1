...
import 'package:flutter_application_1/screen/official_mobile/action.dart'; // Import the action page
...
class PendingPostCard extends StatefulWidget {
  ...
  /// NEW: deadline days (default 7 days)
...
class _PendingPostCardState extends State<PendingPostCard> {
  ...
  /// Calculate remaining deadline days
    ...
    return Card(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            /// Top Row - Profile + Name/Time + Safety & Priority + Deadline
            Row(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                CircleAvatar(
                ...
                /// Right side (Safety + Priority stacked vertically + Deadline)
                Column(
            ...
            Row(
              children: [
                const Icon(Icons.location_on, size: 14, color: Colors.red), // <-- your icon
                ...
                ElevatedButton(
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => const ProofAction(),
                      ),
                    );
                  },
