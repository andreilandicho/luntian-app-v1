...
class ViewPostCard extends StatefulWidget {
  ...
  @override
  State<ViewPostCard> createState() => _ViewPostCardState();
}

class _ViewPostCardState extends State<ViewPostCard> {
  late int upvotes;
  late int downvotes;
  bool upvoted = false;
